...
class AddScheduleVerticalAdapter(private val context: Context) :
    RecyclerView.Adapter<AddScheduleVerticalAdapter.VerticalViewHolder>() {

    var datas = mutableListOf<AddScheduleModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VerticalViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.item_add_schedule_vertical, parent, false)

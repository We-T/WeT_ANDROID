...
class SelectTourLocationAdapter(private val context: Context, private val onClickSelectPlace: OnClickSelectPlace): RecyclerView.Adapter<SelectTourLocationAdapter.SelectTourLocationViewHolder>() {

    var datas = mutableListOf<SelectTourLocationData>()

    inner class SelectTourLocationViewHolder(itemView: View, onClickSelectPlace: OnClickSelectPlace): RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SelectTourLocationViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_select_tour_location, parent, false)
        return SelectTourLocationViewHolder(view, onClickSelectPlace)
    }

    override fun onBindViewHolder(holder: SelectTourLocationViewHolder, position: Int) {
